...
help:
	@echo 'Management commands for DSiSc/web3go:'
	@echo
	@echo 'Usage:'
...
build:
	@echo "building web3go ${VERSION}"
	@echo "GOPATH=${GOPATH}"
	go build -v -ldflags "-X github.com/DSiSc/web3go/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/DSiSc/web3go/version.BuildDate=${BUILD_DATE}" ./...
